...
@Entity
@Table(schema = "kubernetes", name = "kubernetes_storage_class")
@Data
public class KubernetesStorageClass {
...
@Column private boolean allowVolumeExpansion;

@Column(columnDefinition = "jsonb")
private Object allowedTopologies;
